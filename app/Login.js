    ...
    return (
        <>
            <div className="flex justify-center items-center h-screen text-black bg-white">
                <div className="flex flex-row gap-6 w-1/2 bg-white shadow-md shadow-black rounded-lg justify-center items-center relative">
                    <div className="py-8 flex flex-col gap-4 w-2/4 h-full items-center rounded-lg">
                        <h2 className="text-lg font-bold">Sign In</h2>
                        <div className="flex gap-4">
                            <a href="#" role="button" className="h-9">
                                <div className="rounded-full mb-2 inline-block p-3 text-xs shadow-sm transition-all ease-in-out hover:fill-blue-500 hover:shadow-blue-500 hover:cursor-pointer">
          ...
          109-82.8H204.8v-66h181.3zm185.4 6.4V179.2h-56v55.7h-55.7v56h55.7v55.7h56v-55.7H627.2v-56h-55.7z" />
              ...
              61.9 111.3 142.3V448z" />
                        ...
                        <div className="text-sm text-gray-700"><h5>or use your account</h5></div>
                    ...
                    <div className={`z-10 absolute bg-red-600 text-white w-1/2 h-full flex flex-col justify-center items-center gap-8 p-10 transition-all duration-1000 ${style} ${anim}`}>
